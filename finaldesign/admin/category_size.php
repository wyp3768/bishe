                ...
                <div class="layui-form-pane" style="margin-top: 15px;">
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:120px">
                        <input type="text" name="size"  placeholder="大小" autocomplete="off" class="layui-input">
                    </div>
                    <!-- <div class="layui-input-inline" style="width:120px">
            ...
            <table class="layui-table">
                ...
                <tbody id="x-link">
                    ...
                    <tr>
                        ...
                        <td><?=$v['size']?></td>
                        <td class="td-manage">
                            <a title="编辑" href="javascript:;" onclick="cate_edit('编辑分类','cate-edit-si.php?id=<?=$v['id']?>','<?=$v['id']?>','','510')"
        ...
        <script>
            $(function(){
                layui.use('layer',function(){
                    ...
                    $('.sub').click(function(){
                        ...
                        $.ajax({
                            url:'../common/ajax.php?type=add_cate_si',
                            data:{size:size},
                            type:'post',
                            dataType:'json',
            ...
            //批量删除提交
             function delAll () {
                layer.confirm('确认要删除吗？',function(index){
                    ...
                    str = arr.join(',');
                    $.ajax({
                        url:'../common/ajax.php?type=delAllsize',
                        data:{ids:str},
                        type:'post',
                        dataType:'json',
                        success:function(data){
            ...
            function cate_del(obj,id){
                layer.confirm('确认要删除吗？',function(index){
                    ...
                    $.ajax({
                        url:'../common/ajax.php?type=del_cate_si',
                        data:{id:id},
                        type:'post',
                        dataType:'json',
                        success:function(data){
