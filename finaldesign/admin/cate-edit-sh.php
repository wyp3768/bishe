<?php
    ...
    $sql_select = "SELECT shape FROM `wyp_cate_shape` WHERE id = ".$id;
        ...
        <div class="x-body">
            <form class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="cname" name="shape" required="" lay-verify="required"
                        autocomplete="off" class="layui-input" value="<?=$rows['shape']?>">
                    </div>
                </div>
            ...
            $(function(){
                layui.use(['layer'], function(){
                    ...
                    $('.layui-btn').click(function(){
                        ...
                        $.ajax({
                            url:'../common/ajax.php?type=update_cate_sh',
                            data:{id:<?=$id?>,shape:shape},
                            type:'post',
                            dataType:'json',
