<?php
    ...
    $sql_select = "SELECT size FROM `wyp_cate_size` WHERE id = ".$id;
        ...
        <div class="x-body">
            <form class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="cname" name="size" required="" lay-verify="required"
                        autocomplete="off" class="layui-input" value="<?=$rows['size']?>">
                    </div>
                </div>
            ...
            $(function(){
                layui.use(['layer'], function(){
                    ...
                    $('.layui-btn').click(function(){
                        ...
                        $.ajax({
                            url:'../common/ajax.php?type=update_cate_si',
