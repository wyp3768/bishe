<?php
    ...
    $sql_select = "SELECT banner,banner_sort,banner_link,banner_desc FROM `wyp_banner_little` WHERE id = ".$id;
        ...
        <div class="x-body">
            <form class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <img id="LAY_demo_upload" width="50" height="50" src="<?=$rows['banner']?>">
                </div>
                <div class="layui-form-item">
            ...
            layui.use(['form','layer','upload'], function(){
              ...
              //图片上传接口
                ...
                $('.sub').click(function(){
                    ...
                    //     )
                    $.ajax({
                        url:'../common/ajax.php?type=update_banner_l',
                        data:{
                            id:<?=$id?>,
                            banner:banner,
